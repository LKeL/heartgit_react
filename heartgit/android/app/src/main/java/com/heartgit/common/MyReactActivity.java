...
/**
 * Created by heartblood on 16/6/11.
 */
public abstract class MyReactActivity extends AppCompatActivity implements DefaultHardwareBackBtnHandler{
    ...
    /**
     * set any layout or view if it need and return false if you set it
     * or react view would be set
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean isSetReactContentView = setReactContentView(mReactRootView);
        mReactInstanceManager = createReactInstanceManager();
        mReactRootView = createRootView();
        mReactRootView.startReactApplication(mReactInstanceManager, getMainComponentName(), getLaunchOptions());
        if (isSetReactContentView) {
